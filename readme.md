...
Важно отметить, что на практике применение данной эвристики не дает видимого ухудшения стоимости финального дерева по сравнению с базовой версией, однако кардинально сокращает количество перерасчетов MST.
...
В результирующем файле структура расширяется:д.
